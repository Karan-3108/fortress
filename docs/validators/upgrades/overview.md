...
Planned upgrades are coordinated scheduled upgrades that use the [upgrade module](https://docs.fortress.org/modules/upgrade/) logic. This facilitates smoothly upgrading Fortress to a new (breaking) software version as it automatically handles the state migration for the new release.

#### Governance Proposal

Governance Proposals are a mechanism for coordinating an upgrade at a given height or time using an [`SoftwareProposal`](https://docs.fortress.org/modules/upgrade/01_concepts.html#proposal).
