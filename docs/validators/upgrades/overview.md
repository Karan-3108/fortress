...
Planned upgrades are coordinated scheduled upgrades that use the [upgrade module](https://docs.cosmos.network/main/modules/upgrade/) logic. This facilitates smoothly upgrading Fortress to a new (breaking) software version as it automatically handles the state migration for the
