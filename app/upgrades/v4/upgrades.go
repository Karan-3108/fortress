...
import (
	...
	"github.com/Karan-3108/fortress/v4/types"
)
...
func UpdateIBCClients(ctx sdk.Context, k ibcclientkeeper.Keeper) error {
	proposalOsmosis := &ibcclienttypes.ClientUpdateProposal{
		...
		Description:        "Update the existing expired Cosmos Hub IBC client on Fortress (07-tendermint-0) in order to resume packet transfers between both chains.",
	...
	proposalCosmosHub := &ibcclienttypes.ClientUpdateProposal{
		...
		Description:        "Update the existing expired Cosmos Hub IBC client on Fortress (07-tendermint-3) in order to resume packet transfers between both chains.",
