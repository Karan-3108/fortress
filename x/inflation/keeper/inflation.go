...
import (
	...
	fortress "github.com/Karan-3108/fortress/v4/types"
	incentivestypes "github.com/Karan-3108/fortress/v4/x/incentives/types"
	"github.com/Karan-3108/fortress/v4/x/inflation/types"
)
...
func (k Keeper) BondedRatio(ctx sdk.Context) sdk.Dec {
	...
	isMainnet := fortress.IsMainnet(ctx.ChainID())
...
func (k Keeper) GetCirculatingSupply(ctx sdk.Context) sdk.Dec {
	...
	if fortress.IsMainnet(ctx.ChainID()) {
