...
func init() {
	proto.RegisterType((*MsgSendIbcPost)(nil), "Karan3108.fortress.blog.MsgSendIbcPost")
	proto.RegisterType((*MsgSendIbcPostResponse)(nil), "Karan3108.fortress.blog.MsgSendIbcPostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	,
}
...
func (c *msgClient) SendIbcPost(ctx context.Context, in *MsgSendIbcPost, opts ...grpc.CallOption) (*MsgSendIbcPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Karan3108.fortress.blog.Msg/SendIbcPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SendIbcPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Karan3108.fortress.blog.Msg/SendIbcPost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "Karan3108.fortress.blog.Msg",
