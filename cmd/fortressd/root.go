...
import (
	...
	cmdcfg "github.com/Karan-3108/fortress/v4/cmd/config"
	fortresskr "github.com/Karan-3108/fortress/v4/crypto/keyring"
)
...
func initAppConfig(chainID string) (string, interface{}) {
	...
	if strings.HasPrefix(chainID, "fortress_9001-") && (srvCfg.MinGasPrices == "" || srvCfg.MinGasPrices == "0fortress") {
