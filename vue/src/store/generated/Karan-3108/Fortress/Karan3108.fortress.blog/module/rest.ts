...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/Karan-3108/fortress/blog/post
   */
  queryPostAll = (
    query?: {
    ...
    this.request<BlogQueryAllPostResponse, RpcStatus>({
      path: `/Karan-3108/fortress/blog/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/Karan-3108/fortress/blog/sent_post
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/Karan-3108/fortress/blog/sent_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/Karan-3108/fortress/blog/timedout_post
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/Karan-3108/fortress/blog/timedout_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/Karan3108/fortress/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/Karan3108/fortress/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
