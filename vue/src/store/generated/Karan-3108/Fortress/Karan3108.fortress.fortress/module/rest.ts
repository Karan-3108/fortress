...
export interface FortressFortress {
  /** @format uint64 */
  id?: string;
  amount?: string;
  fee?: string;
...
export type FortressMsgApproveFortressResponse = object;

export type FortressMsgCancelFortressResponse = object;

export type FortressMsgLiquidateFortressResponse = object;

export type FortressMsgRepayFortressResponse = object;

export type FortressMsgRequestFortressResponse = object;
 ...
 */
export interface FortressQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryFortressAll
   * @summary Queries a list of Fortress items.
   * @request GET:/Karan-3108/fortress/fortress/fortress
   */
  queryFortressAll = (
    query?: {
    ...
    this.request<FortressQueryAllFortressResponse, RpcStatus>({
      path: `/Karan-3108/fortress/fortress/fortress`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryFortress
   * @summary Queries a Fortress by id.
   * @request GET:/Karan-3108/fortress/fortress/fortress/{id}
   */
   ...
   * @request GET:/Karan3108/fortress/fortress/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<FortressQueryParamsResponse, RpcStatus>({
      path: `/Karan3108/fortress/fortress/params`,
      method: "GET",
      format: "json",
      ...params,
    });
