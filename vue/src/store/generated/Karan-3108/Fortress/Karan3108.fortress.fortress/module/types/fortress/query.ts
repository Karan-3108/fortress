...
export interface QueryGetFortressRequest {
  id: number;
}

export interface QueryGetFortressResponse {
  Fortress: Fortress | undefined;
}

export interface QueryAllFortressRequest {
  pagination: PageRequest | undefined;
}

export interface QueryAllFortressResponse {
  Fortress: Fortress[];
...
const baseQueryGetFortressRequest: object = { id: 0 };

export const QueryGetFortressRequest = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetFortressRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetFortressRequest,
    } as QueryGetFortressRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetFortressRequest {
    const message = {
      ...baseQueryGetFortressRequest,
    } as QueryGetFortressRequest;
  ...
  toJSON(message: QueryGetFortressRequest): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<QueryGetFortressRequest>
  ): QueryGetFortressRequest {
    const message = {
      ...baseQueryGetFortressRequest,
    } as QueryGetFortressRequest;
    if (object.id !== undefined && object.id !== null) {
...
const baseQueryGetFortressResponse: object = {};

export const QueryGetFortressResponse = {
  encode(
    message: QueryGetFortressResponse,
    writer: Writer = Writer.create()
  ): Writer {
    if (message.Fortress !== undefined) {
      Fortress.encode(message.Fortress, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  ...
  decode(
    ...
    length?: number
  ): QueryGetFortressResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetFortressResponse,
    } as QueryGetFortressResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.Fortress = Fortress.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): QueryGetFortressResponse {
    const message = {
      ...baseQueryGetFortressResponse,
    } as QueryGetFortressResponse;
    if (object.Fortress !== undefined && object.Fortress !== null) {
      message.Fortress = Fortress.fromJSON(object.Fortress);
    } else {
      message.Fortress = undefined;
    }
    return message;
  },

  toJSON(message: QueryGetFortressResponse): unknown {
    const obj: any = {};
    message.Fortress !== undefined &&
      (obj.Fortress = message.Fortress
        ? Fortress.toJSON(message.Fortress)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetFortressResponse>
  ): QueryGetFortressResponse {
    const message = {
      ...baseQueryGetFortressResponse,
    } as QueryGetFortressResponse;
    if (object.Fortress !== undefined && object.Fortress !== null) {
      message.Fortress = Fortress.fromPartial(object.Fortress);
    } else {
      message.Fortress = undefined;
    }
    return message;
...
const baseQueryAllFortressRequest: object = {};

export const QueryAllFortressRequest = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryAllFortressRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllFortressRequest,
    } as QueryAllFortressRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryAllFortressRequest {
    const message = {
      ...baseQueryAllFortressRequest,
    } as QueryAllFortressRequest;
  ...
  toJSON(message: QueryAllFortressRequest): unknown {
    const obj: any = {};
    message.pagination !== undefined &&
  ...
  fromPartial(
    object: DeepPartial<QueryAllFortressRequest>
  ): QueryAllFortressRequest {
    const message = {
      ...baseQueryAllFortressRequest,
    } as QueryAllFortressRequest;
    if (object.pagination !== undefined && object.pagination !== null) {
...
const baseQueryAllFortressResponse: object = {};

export const QueryAllFortressResponse = {
  encode(
    message: QueryAllFortressResponse,
    writer: Writer = Writer.create()
  ): Writer {
    for (const v of message.Fortress) {
      Fortress.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.pagination !== undefined) {
      PageResponse.encode(
        message.pagination,
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllFortressResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllFortressResponse,
    } as QueryAllFortressResponse;
    message.Fortress = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.Fortress.push(Fortress.decode(reader, reader.uint32()));
          break;
        case 2:
  ...
  fromJSON(object: any): QueryAllFortressResponse {
    const message = {
      ...baseQueryAllFortressResponse,
    } as QueryAllFortressResponse;
    message.Fortress = [];
    if (object.Fortress !== undefined && object.Fortress !== null) {
      for (const e of object.Fortress) {
        message.Fortress.push(Fortress.fromJSON(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
  ...
  toJSON(message: QueryAllFortressResponse): unknown {
    const obj: any = {};
    if (message.Fortress) {
      obj.Fortress = message.Fortress.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryAllFortressResponse>
  ): QueryAllFortressResponse {
    const message = {
      ...baseQueryAllFortressResponse,
    } as QueryAllFortressResponse;
    ...
    if (object.Fortress !== undefined && object.Fortress !== null) {
      for (const e of object.Fortress) {
        message.Fortress.push(Fortress.fromPartial(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
...
export interface Query {
  ...
  Fortress(request: QueryGetFortressRequest): Promise<QueryGetFortressResponse>;
  /** Queries a list of Fortress items. */
  FortressAll(
    request: QueryAllFortressRequest
  ): Promise<QueryAllFortressResponse>;
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "Karan3108.fortress.fortress.Query",
      "Params",
      data
    );
  ...
  Fortress(
    request: QueryGetFortressRequest
  ): Promise<QueryGetFortressResponse> {
    const data = QueryGetFortressRequest.encode(request).finish();
    const promise = this.rpc.request(
      "Karan3108.fortress.fortress.Query",
      "Fortress",
      data
    ...
    return promise.then((data) =>
      QueryGetFortressResponse.decode(new Reader(data))
    );
  }
  ...
  FortressAll(
    ...
    const data = QueryAllFortressRequest.encode(request).finish();
    const promise = this.rpc.request(
      "Karan3108.fortress.fortress.Query",
      "FortressAll",
      data
    ...
    return promise.then((data) =>
      QueryAllFortressResponse.decode(new Reader(data))
    );
  }
